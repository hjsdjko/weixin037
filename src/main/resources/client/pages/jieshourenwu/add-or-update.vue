	...
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="select">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">订单状态</view>
				<picker :style='{"width":"100%","flex":"1","height":"auto"}' @change="dingdanzhuangtaiChange" :value="dingdanzhuangtaiIndex" :disabled="true" :range="dingdanzhuangtaiOptions">
					<view :style='{"width":"100%","lineHeight":"80rpx","fontSize":"28rpx","color":"#666666"}' class="uni-input">{{ruleForm.dingdanzhuangtai?ruleForm.dingdanzhuangtai:"请选择订单状态"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">接受时间</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-model="ruleForm.jieshoushijian" placeholder="接受时间" @tap="toggleTab('jieshoushijian')"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">接单人账号</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.jiedanrenzhanghao" v-model="ruleForm.jiedanrenzhanghao" placeholder="接单人账号"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">接单人姓名</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.jiedanrenxingming" v-model="ruleForm.jiedanrenxingming" placeholder="接单人姓名"></input>
			</view>
			<view :style='{"padding":"4rpx 0 4rpx 0","margin":"0 0 24rpx 0","borderColor":"#cccccc","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0px","background":"#e7fefc","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333333","textAlign":"right"}' class="title">联系方式</view>
				<input :style='{"border":"0px solid #eeeeee","padding":"0px 24rpx 0px 24rpx","margin":"0 0 0 0","color":"#666666","borderRadius":"8rpx","flex":"1","background":"#ffffff00","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' :disabled="ro.lianxifangshi" v-model="ruleForm.lianxifangshi" placeholder="联系方式"></input>
			</view>
		...
		<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="jieshoushijianConfirm" ref="jieshoushijian" themeColor="#333333"></w-picker>
	</view>
</view>
</template>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
            this.ruleForm.jieshoushijian = this.$utils.getCurDateTime();
			...
			// ss读取
			this.ruleForm.jiedanrenzhanghao = this.user.zhanghao
			this.ro.jiedanrenzhanghao = true;
			this.ruleForm.jiedanrenxingming = this.user.xingming
			this.ro.jiedanrenxingming = true;
			this.ruleForm.lianxifangshi = this.user.shouji
			this.ro.lianxifangshi = true;

            this.ro.dingdanzhuangtai = true;

			// 自定义下拉框值
			this.dingdanzhuangtaiOptions = "已完成,已取消".split(',')
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`jieshourenwu`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='jieshoushijian'){
					this.ruleForm.jieshoushijian = obj[o];
					this.ro.jieshoushijian = true;
					continue;
					}
					if(o=='jiedanrenzhanghao'){
					this.ruleForm.jiedanrenzhanghao = obj[o];
					this.ro.jiedanrenzhanghao = true;
					continue;
					}
					if(o=='jiedanrenxingming'){
					this.ruleForm.jiedanrenxingming = obj[o];
					this.ro.jiedanrenxingming = true;
					continue;
					}
					if(o=='lianxifangshi'){
		...
		methods: {
			...
			// 日长控件选择日期时间
			jieshoushijianConfirm(val) {
				console.log(val)
				this.ruleForm.jieshoushijian = val.result;
				this.$forceUpdate();
			},
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`jieshourenwu`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`jieshourenwu`, this.ruleForm);
						}else{
							await this.$api.add(`jieshourenwu`, this.ruleForm);
						}
